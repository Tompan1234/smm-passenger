...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/orders/update.do" method="post">
				<!-- 正文区域 -->
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" placeholder="会员id"
								   name="memberId" value="${order.memberId}">
						</div>
							...
							<select class="form-control select2" style="width: 100%"
								...
								<c:choose>
									...
									<c:otherwise>
										...
										<option value="1" selected="selected">已经支付</option>
									</c:otherwise>
								</c:choose>
							</select>
						</div>
						...
						<div class="col-md-10 data rowHeight2x">
							<textarea class="form-control" rows="3" placeholder="其他信息" name="orderDesc">${order.orderDesc}</textarea>
						</div>
					</div>
				</div>
				<!--订单信息/--> <!--工具栏-->
